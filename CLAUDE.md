...
- **CS-07**: **NEVER** use emoji, or unicode that emulates emoji (e.g. check marks, X marks). Exceptions: (1) tests verifying multibyte character handling; (2) interactive TUI display elements (icons, spinners) rendered only in terminal output, with an `//nolint:revive` citing this exception.
